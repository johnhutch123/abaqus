...
def getDisps1(i):
    ...
    o1= session.openOdb(name='C:/Users/pqb18127/OneDrive/PhD/Python/DEAP/multiprocessing/Multiprocessing abaqus/mp' + str(i) + '.odb')
    session.viewports['Viewport: 1'].setValues(displayedObject=o1)
    session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=1)
    odb = session.odbs['C:/Users/pqb18127/OneDrive/PhD/Python/DEAP/multiprocessing/Multiprocessing abaqus/mp' + str(i) + '.odb']
